...
#
# Generated by Vivado on Fri Aug 03 19:12:48 -0700 2018
...
# Create project
create_project ${project_name} ./${project_name} -part xc7k70tfbv676-1 -force
...
set_property -name "top" -value "flex_spi_tb" -objects $obj
...
if {[string equal [get_runs -quiet synth_1] ""]} {
  create_run -name synth_1 -part xc7k70tfbv676-1 -flow {Vivado Synthesis 2017} -strategy "Vivado Synthesis Defaults" -constrset constrs_1
} else {
...
if {[string equal [get_runs -quiet impl_1] ""]} {
  create_run -name impl_1 -part xc7k70tfbv676-1 -flow {Vivado Implementation 2017} -strategy "Vivado Implementation Defaults" -constrset constrs_1 -parent_run synth_1
} else {
