...
# Switches
set_property -dict {PACKAGE_PIN V17 IOSTANDARD LVCMOS33} [get_ports { clk_select }];
...
# LEDs
# Show Button Output
set_property -dict {PACKAGE_PIN U16 IOSTANDARD LVCMOS33} [get_ports { show_button }];
...
set_property -dict {PACKAGE_PIN U17 IOSTANDARD LVCMOS33} [get_ports {button_clock}];
